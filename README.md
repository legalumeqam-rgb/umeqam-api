...
4. **Sector Compliance** — enforces sector-specific rules (medical, legal, financial)
...
|---|---|---|
| **UMEQAM Medical** | Blocks false AI outputs in healthcare — diagnoses, prescriptions, treatment claims | EU AI Act Article 9 · WHO Digital Health |
| **UMEQAM Legal** | Blocks legally dangerous AI outputs — guaranteed verdicts, false authority claims | EU AI Act · Bar Association Standards |
| **UMEQAM Finance** | Blocks harmful financial AI outputs — guaranteed returns, manipulation detection | MiFID II · FCA Consumer Duty · FINRA |
| **ELB** | Routes LLM queries to the right compute tier in 0.089ms · 99.6% accuracy · 41% energy saved | — |
...
Weights are sector-specific. Healthcare applies stricter epistemic weighting than finance.
...
| [elb](https://github.com/legalumeqam-rgb/elb) | LLM query router · 0.089ms · 99.6% accuracy · 41% energy saved |
